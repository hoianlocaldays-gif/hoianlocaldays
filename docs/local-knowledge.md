...
- **A — Verified fact:** supported by reliable independent evidence.
- **B — Owner local observation:** current local/operator experience; not universal.
- **C — Editorial judgment:** HAL recommendation or interpretation.
- **D — Needs verification:** do not publish as established fact yet.

## Cam Thanh

| Claim | Class | Source/evidence | Publication caution |
| --- | --- | --- | --- |
| Cam Thanh forms part of the estuarine/marsh landscape east of Hoi An, south of the Thu Bon River. | A | UNESCO, Cu Lao Cham–Hoi An Biosphere Reserve: https://www.unesco.org/en/mab/cu-lao-cham-hoi | Use for broad ecological/geographic context only. |
| Bay Mau Coconut Forest lies in the Cam Thanh area near Hoi An and contains a network of waterways and nipa palms. | A | Da Nang tourism portal: https://danangfantasticity.com/en/bay-mau-coconut-forest | Administrative naming changed after 2025; avoid overloading visitor copy with boundary details. |
| Basket boats were used for fishing and passenger transport before becoming a tourism experience. | A | Hoi An heritage portal: https://www.hoianworldheritage.org.vn/en/news/print/Culture-Art/hoi-an-creates-from-heritage-builds-for-the-future-886.hwh | Do not invent dates or claim one single origin story. |
| Nipa palms supplied material for traditional bamboo-and-palm house construction. | A | Da Nang tourism portal: https://danangfantasticity.com/en/see-and-do/the-craft-of-bamboo-and-coconut-house-construction-in-cam-thanh | Keep claims at craft/context level. |
| Morning and early afternoon generally feel more comfortable; midday is hotter. | B | Owner local observation, reviewed 2026-08-28 | Weather varies; do not guarantee conditions. |
| Late afternoon can expose shallower water and more mud. | B | Owner local observation, reviewed 2026-08-28 | Tides vary by date; never state a fixed daily pattern. |
| Main wharf/activity areas are lively; quieter rides generally operate toward the edges. | B | Owner local observation, reviewed 2026-08-28 | Subjective atmosphere; phrase as local observation. |
| A typical ride is roughly 40–50 minutes. | B | Owner reference plus current Da Nang tourism listing (45/60-minute products) | Operators and packages vary. |
| Local reference: entrance about VND 30,000; boat about VND 120,000–150,000 for up to two adults. | B | Owner reference; Da Nang portal currently lists VND 30,000 entrance and VND 150,000/45 min or VND 180,000/60 min | Date every price; distinguish local ride from packaged tours. |
| Spinning may be a separate optional activity; local reference around VND 100,000. | B | Owner local observation | Not an official or fixed price. Ask first. |
| A voluntary tip around VND 20,000–50,000 may be appreciated. | B | Owner local observation | Never imply tipping is mandatory. |
| The central experience can be touristy but still worthwhile for many first-time visitors. | C | HAL editorial judgment informed by owner observation | Explain who may not enjoy it. |
| Detailed wartime role, dates, battles and military events. | D | Some tourism/heritage references mention wartime significance, but evidence gathered is not detailed enough | Omit until checked against a recognized historical institution. |

## Cooking Classes

| Claim | Class | Source/evidence | Publication caution |
| --- | --- | --- | --- |
| A useful class should balance enjoyment, organization, practical learning and cultural context. | C | Owner editorial benchmark | Present as HAL evaluation criteria, not industry law. |
| Choosing only by the lowest price can overlook teaching quality, group size, cleanliness and interaction. | B/C | Owner observation and HAL judgment | Do not imply price predicts quality in every case. |
| Market visits are most useful when ingredients connect clearly to dishes and local food habits. | C | Owner editorial benchmark | Avoid claiming a particular tour delivers this unless verified. |
| Cooking-only can suit travelers who already visited a market or did a basket boat ride. | C | HAL decision guidance | Check individual inclusions. |
| Experience quality may decline in very large groups; staffing and layout matter. | B | Owner observation | Do not publish “15 guests” as a universal threshold. |
| Dietary requirements should be discussed with the provider before booking/arrival. | B | Owner operational observation | No medical or cross-contamination guarantees. |
| Families should verify supervision around knives, heat and equipment. | B | Owner operational observation | No safety guarantees. |
| “Travelers can recreate 70% at home.” | D | Owner internal benchmark | Do not publish as objective data. |

## Hoi An Food

| Claim | Class | Source/evidence | Publication caution |
| --- | --- | --- | --- |
| Owner&apos;s five first-time priorities: cao lau, chicken rice, banh mi, Hoi An-style banh xeo, banh dap with Cam Nam clams. | B/C | Owner local knowledge and editorial selection | Clearly label as HAL/owner selection, not a definitive canon. |
| Cao lau is not a soup like pho; it uses chewy noodles, a relatively small amount of concentrated sauce, pork, herbs and crisp elements. | B | Owner local knowledge | Historical origin claims require independent sourcing. |
| Hoi An-style banh xeo is typically eaten hot and crisp, wrapped with herbs and dipped in sauce. | B | Owner local knowledge | Recipe details vary. |
...
| Claim | Class | Source/evidence | Publication caution |
| --- | --- | --- | --- |
| Around 06:00–08:00 is the owner&apos;s preferred window; 07:30–09:00 remains useful. | B | Owner local observation | Trading activity and hours vary by day/season. |
