...
export function MySonPage() {
  const breadcrumb = breadcrumbJsonLd([
    ...
    { name: "My Son Sanctuary from Hoi An", url: "https://hoianlocaldays.com/my-son-tours-from-hoi-an" },
  ]);
  return <main className="my-son-page">
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumb) }} />
    <div className="breadcrumb"><Link href="/">Home</Link><span>›</span><Link href="/things-to-do-in-hoi-an">Things to Do</Link><span>›</span><span>My Son Sanctuary</span></div>

    <section className="my-son-hero section"><p className="eyebrow">Cultural trip from Hoi An</p><h1>My Son Sanctuary from Hoi An: How to Choose the Right Trip</h1><p>A practical guide to visiting My Son from Hoi An — including morning vs afternoon, group vs private trips, transport options and who the experience suits best.</p><EditorSignal /><div className="hero-actions"><a className="primary-button" href="#choose-your-visit">Find Your Best Way to Visit</a><Link className="secondary-button" href="/3-days-in-hoi-an">See a 3-Day Hoi An Itinerary</Link></div></section>

    <section className="my-son-answer section"><div><p className="eyebrow">The quick answer</p><h2>Is My Son Worth Visiting From Hoi An?</h2></div><div><p><strong>It can be a very worthwhile addition</strong> for travelers interested in history, architecture, archaeology, Cham heritage and cultural sites beyond Hoi An Ancient Town.</p><p>It may be less compelling if your time is very limited and your priorities are mainly food, beaches or hands-on activities. My Son is an option with a clear cultural focus—not a stop every visitor must make.</p></div></section>

    <section className="my-son-context section"><div><p className="eyebrow">Concise context</p><h2>What Is My Son Sanctuary?</h2></div><p>My Son is a UNESCO World Heritage Site associated with the Champa civilization. The sanctuary contains Hindu temple structures whose historical development spans roughly the 4th to 13th centuries. It sits outside Hoi An, so every visit requires a transport decision as well as a choice about how much interpretation you want.</p></section>
    ...
    <section className="my-son-alternatives section"><div className="my-son-heading"><p className="eyebrow">Choose the right priority</p><h2>My Son or Another Hoi An Experience?</h2></div><div className="my-son-alternative-grid"><article><h3>Choose My Son</h3><p>If history, architecture and culture matter most.</p></article><article><h3>Choose a Cooking Class</h3><p>If food and a hands-on activity matter most.</p><TrackedLink href="/cooking-classes-hoi-an" sourcePage="my-son-tours-from-hoi-an" destinationPage="/cooking-classes-hoi-an" section="alternatives" ctaId="myson_cooking">Compare cooking classes →</TrackedLink></article><article><h3>Choose Basket Boats</h3><p>If you want a shorter, lighter activity.</p><TrackedLink href="/basket-boat-hoi-an" sourcePage="my-son-tours-from-hoi-an" destinationPage="/basket-boat-hoi-an" section="alternatives" ctaId="myson_basket_boat">Compare basket boats →</TrackedLink></article><article><h3>Stay in Hoi An</h3><p>If time is limited and you have not explored Ancient Town yet.</p><Link href="/things-to-do-in-hoi-an">Explore things to do →</Link></article></div></section>

    <section className="my-son-itinerary section"><div><p className="eyebrow">Planning context</p><h2>Where My Son Fits Into a Hoi An Itinerary</h2></div><div><p>For a three-day stay, My Son works best as a cultural option when you have already protected time for Ancient Town and do not need to fit every signature activity into the same day. It is not a mandatory part of the plan.</p><Link className="primary-button" href="/3-days-in-hoi-an">See Our 3-Day Hoi An Itinerary</Link></div></section>
