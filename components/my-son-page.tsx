...
export function MySonPage() {
  ...
  return <main className="my-son-page">
    ...
    <section className="my-son-alternatives section"><div className="my-son-heading"><p className="eyebrow">Choose the right priority</p><h2>My Son or Another Hoi An Experience?</h2></div><div className="my-son-alternative-grid"><article><h3>Choose My Son</h3><p>If history, architecture and culture matter most.</p></article><article><h3>Choose a Cooking Class</h3><p>If food and a hands-on activity matter most.</p><Link href="/cooking-classes-hoi-an">Compare cooking classes →</Link></article><article><h3>Choose Basket Boats</h3><p>If you want a shorter, lighter activity.</p><Link href="/basket-boat-hoi-an">Compare basket boats →</Link></article><article><h3>Stay in Hoi An</h3><p>If time is limited and you have not explored Ancient Town yet.</p><Link href="/things-to-do-in-hoi-an">Explore things to do →</Link></article></div></section>
