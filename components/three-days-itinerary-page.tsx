...
export function ThreeDaysItineraryPage() {
  ...
  return <main className="itinerary-page">
    ...
    <section className="itinerary-day section" id="day-1"><div className="itinerary-day-heading"><span>Day 1</span><h2>Day 1 — Ancient Town, Food &amp; Lanterns</h2><p>{days[0].summary}</p><Link className="context-link" href="/hoi-an-old-town-guide">Orient yourself with the Hoi An Old Town guide →</Link><br /><Link className="context-link" href="/hoi-an-food-guide">Use our first-timer food guide to choose what to eat →</Link><br /><Link className="context-link" href="/hoi-an-market-guide">Know when to visit Hoi An Market and what to notice →</Link></div><DaySections day={days[0]} /></section>
