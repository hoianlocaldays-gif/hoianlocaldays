...
export function RelatedGuides() {
  return <section className="section cooking-next"><p className="eyebrow">Related guides</p><h2>Keep Planning Your Hoi An Trip</h2><div><Link href="/">Homepage <span>→</span></Link><Link href="/things-to-do-in-hoi-an">Things to Do <span>→</span></Link><Link href="/hoi-an-with-kids">Hoi An With Kids <span>→</span></Link></div></section>;
}
