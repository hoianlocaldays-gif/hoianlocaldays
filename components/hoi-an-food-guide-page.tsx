...
export function HoiAnFoodGuidePage() {
  ...
  return <main className="food-guide-page">
    ...
    <section className="food-market section" id="market">
      ...
      <div><p>Based on current local observation, roughly 06:00–08:00 is the strongest window for active produce, meat, fish and seafood trade; 07:30–09:00 can still be useful. These are planning windows, not guaranteed opening hours for every stall or day.</p><p>Notice herbs, green papaya, banana blossom, spices, sauces and unfamiliar produce. Tra Que&apos;s vegetable-growing tradition is officially associated with herbs and greens used in dishes including cao lau, Mi Quang and banh xeo, but not every herb in every Hoi An meal should automatically be claimed as Tra Que produce.</p><div className="market-etiquette"><h3>Market etiquette that helps</h3><ul><li>Ask before close-up photographs of vendors.</li><li>Ask before touching or selecting produce.</li><li>Keep working lanes and customer space clear.</li><li>Avoid aggressive bargaining over a small amount.</li><li>Interact with curiosity rather than treating the market as a photo set.</li></ul></div><p>The evening market is a different experience: useful for snacks and atmosphere, but not a substitute for observing the morning food trade.</p></div>
    </section>
