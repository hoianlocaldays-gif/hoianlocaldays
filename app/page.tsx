  ...
  return <main className="homepage-mvp">
    ...
    <section className="home-picks section" id="picks">
      ...
      <div className="home-picks-grid">
        ...
        <article className="home-pick"><div className="home-pick-art art-boat" aria-hidden="true"><span>Local experience</span></div><div><h3>Basket Boat Experiences</h3><p>Understand the different styles before choosing the atmosphere that suits you.</p><Link href="/basket-boat-hoi-an">Compare Basket Boat Experiences <span>→</span></Link></div></article>
