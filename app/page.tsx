  ...
  return <main className="homepage-mvp">
    ...
    <section className="home-picks section" id="picks">
      ...
      <div className="home-picks-grid">
        ...
        <article className="home-pick"><div className="home-pick-art art-boat" aria-hidden="true"><span>Local experience</span></div><div><h3>Basket Boat Experiences</h3><p>Understand the different styles before choosing the atmosphere that suits you.</p><TrackedLink href="/basket-boat-hoi-an" sourcePage="homepage" destinationPage="/basket-boat-hoi-an" section="featured_picks" ctaId="home_basket_boat">Compare Basket Boat Experiences <span>→</span></TrackedLink></div></article>
        <article className="home-pick"><div className="home-pick-art art-family" aria-hidden="true"><span>Family travel</span></div><div><h3>Hoi An With Kids</h3><p>Practical ideas for families balancing fun, weather and an easy pace.</p><TrackedLink href="/hoi-an-with-kids" sourcePage="homepage" destinationPage="/hoi-an-with-kids" section="featured_picks" ctaId="home_kids">Plan a Family Day <span>→</span></TrackedLink></div></article>
      </div>
    </section>
